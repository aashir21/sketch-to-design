            ...
            <div className='flex items-center justify-between mt-32'>
                <div>
                    ...
                    <p className='text-muted-foreground'>
                        Manage your design projects and continue from where you left off
                    </p>
                </div>
            </div>

            {
                projects.length === 0 ? (
                    <div className='text-center py-20'>
                        ...
                        <p className='text-sm text-muted-foreground mb-6'>Create your first project to gte started</p>
                    </div>
                ) :
                    (
                            ...
                            {projects.map((project: any) => (
                                ...
                                >
                                    <div className='space-y-3'>
                                        <div className='aspect-[4/3] rounded-lg overflow-hidden mg-muted'>
                                            {
                                                project.thumbnail ? (
                                                    <Image
                                        ...
                                        <div className='space-y-1'>
                                            ...
                                            <p className='text-xs text-muted-foreground'>{formatDistanceToNow(new Date(project.lastModified), {
                                                addSuffix: true
                                            })}</p>
                                        </div>
                                    </div>
